...
/**
 * Phase 1 launch batch — 10 head-term + scene + theme keywords chosen for
 * volume × KD. Ordered by descending `vol` so the registry doubles as a
 * priority list when we want to promote top terms first.
 */

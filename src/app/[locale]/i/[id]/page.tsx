 ...
 * Detail route: `/i/{id}`.
 *
 * We intentionally don't include a title-derived slug in the URL anymore.
 * Three reasons:
 *   1. AI-generated titles can be in any language; non-ASCII slugs break
 *      `permanentRedirect`'s Location header (HTTP forbids non-ASCII there).
 *   2. Stable, short URLs are friendlier to share and index.
 *   3. Less surface for encoding bugs.
 *
 * Legacy URLs `/i/{id}/{slug}` are handled by a separate redirect page.
 */
type Props = {
